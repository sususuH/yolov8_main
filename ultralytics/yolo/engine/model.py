...
class YOLO:
    ...
    def __init__(self, model='yolov8l.yaml', type="v8") -> None:
        """
    ...
    def _new(self, cfg: str, verbose=True):
        ...
        ## 改了代码之后，添加这个代码
        ckpt = torch.load('/home/su/su/yolo/yolov8_tracking-master_main/yolov8/model/yolov8l.pt')
    ...
    def predict(self, source, **kwargs):
        ...
        overrides["save_txt"] = kwargs.get("save_txt", True) # 自己添加保存标签
        overrides["save_crop"] = kwargs.get("save_crop", True) # 自己添加保存
    ...
    def train(self, **kwargs):
        ...
        if kwargs.get("cfg"):
            ...
            overrides = yaml_load(check_yaml(kwargs["cfg"]), append_filename=False)         # 运行自己更改后的代码代码需要更改append_filename
